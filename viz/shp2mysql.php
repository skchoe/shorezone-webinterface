...
*/
$conn = mysql_connect("localhost", "seung", "ddtech1@")
  or die("Couldn't connect to my sql server!");
...
for ($count=0; $count < mysql_numrows($result_retrieve); $count++)
  {
	...
	$sc_name = stripslashes(mysql_result($result_retrieve, $count, "sc_name"));
	$cm_name = stripslashes(mysql_result($result_retrieve, $count, "cm_name"));
