...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml">
  ...
  <script src="http://maps.google.com/maps?file=api&v=2&key=ABQIAAAAaRE4sBdQ5nlphMnkzzl5rxRc_pjBLCmAsx0cvy3Edc_xGc3klRRfOgiTiSNGL4DYmIDEm6fXsucNGg" type="text/javascript">
    //var shp_name = 1;//<?php echo $shp_name; ?>;
    //var tbl_name_dbf = 2000;

  </script>

	<title>Query for World Amphibians</title>
  </head>
  <body>
	<h1>Select Location, query for amphibians</h1>
	<div style="width: 200px;" class="tekst"><b></b></div>
	<div id="map" style="width: 1280px;height: 450px;position: absolute;left:20px;"></div>
	<div id="geo" style="width: 300px;position: absolute;left: 20px;top: 500px;" class="tekst">
	<form method="post" action="">
		...
		<tr>
			<td><input type="button" name="Command" value="Find Object" onClick="computeExistence(this.form)"></td>
			<td><input type="button" name="Clear" value="Clear Result" onClick="clearResult(this.form)"></td>
		</tr>
	...
	<!---<div style="width: 960px; position: absolute; left: 320px; top: 500px;" class="smalltekst" id="resultSpan">
        -->
	<div style="width: 3360px; position: absolute; left: 320px; top: 500px;" class="smalltekst" id="resultSpan">
	<p><i>Qeury results:</i></p>
  	<br />
	</div>

<?php
  $shp_name = "SPECIES1109_DBO_VIEW_AMPHIBIANS"; 
  $tbl_name_dbf = "SPECIES1109_DBO_VIEW_AMPHIBIANS_dbf";
...
<script type="text/javascript">
	...
	function ajaxFunction(shp_name, table_name_dbf, lng, lat, zoom)
	{
	  var xmlhttp;
	  ...
	  var url = "run_query_amphibians.php";
	...
	//function computeExistence(frm, shp_name, tbl_name_dbf) {
	function computeExistence(frm) {

	  //ex: "tm_wgs84_sans_antarctica_dst";
	  var shp_name = '<?php echo $shp_name; ?>';
	  //ex: "tm_wgs84_sans_antarctica_dbf";
	  ...
	  ajaxFunction(shp_name, tbl_name_dbf, lng, lat, zoom);
	}
