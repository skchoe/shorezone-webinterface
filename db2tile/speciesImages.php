...
$query_kind = "SELECT source_gri, cm_name, sc_name, taxon_grou, animal_for, has_no_hab, taxon_gr_1 
...
echo "<br/><br/>";
echo "Amphibians<br/><br/>";
echoByTaxonGroup($result_kind, 'A');
echo "<br/><br/>";
echo "Birds<br/><br/>";
echoByTaxonGroup($result_kind, 'B');
echo "<br/><br/>";
echo "Mammals<br/><br/>";
echoByTaxonGroup($result_kind, 'M');
echo "<br/><br/>";
echo "Raptiles<br/><br/>";
echoByTaxonGroup($result_kind, 'R');

mysql_free_result($result_kind);

function echoByTaxonGroup($result_kind, $taxon_grou) {
...
for ($count=0; $count < mysql_numrows($result_kind); $count++) {
  ...
  if($tgrp_symbol == $taxon_grou) {
    ...
    $n_cm = mysql_result($result_kind, $count, "cm_name");
    $n_sc = mysql_result($result_kind, $count, "sc_name");
    echo "<a href=\"http://localhost/viz/speciesExtent.php?species=".$source_gri."\"> [".$source_gri."] ".$n_cm." / ".$n_sc."</a><br>";
  }
}
}
*/
...
for ($count=0; $count < mysql_numrows($result_idset); $count++) {
  ...
  echo "<a href=\"http://localhost/viz/speciesPolygon.php?species=".$source_gri."\"> [".$source_gri."] ".$n_cm." / ".$n_sc."</a><br>";
