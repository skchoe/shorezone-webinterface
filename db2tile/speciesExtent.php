...
<script type="text/javascript" 
	  src="http://www.google.com/maps?file=api
               &amp;v=2
               &amp;key=ABQIAAAAaRE4sBdQ5nlphMnkzzl5rxT2yXp_ZAY8_ufC3CFXhHIE1NvwkxQZEz4eaJLA2PfxBDt8X_NayJ_nzw">
</script>
...
function load()
{
  ...
  if (GBrowserIsCompatible()) {
	...
	var initZoom = map.getBoundsZoomLevel
	  (new GLatLngBounds(new GLatLng(Xmin, Ymin, true), new GLatLng(Xmax, Ymax, true)));
	var properZoom = initZoom - 1;
	map.setCenter(point, initZoom); // currently initZoom is used.
...
<a href="http://localhost/viz/speciesList.php">CLICK HERE TO RETURN TO SPECIES LIST</a>
</font>
<br/>
