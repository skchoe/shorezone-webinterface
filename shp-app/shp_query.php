<?php
$upload_dir = "/home/seung/wss_maps/shp-app/uploads"; // Directory for file storing
                                                            // filesystem path


$web_upload_dir = "/shp-app/uploads"; // Directory for file storing
                                        // Web-Server dir 
...
$html =<<<END
<html><head><title>{$filename} Query from input Shape file</title></head>
<body>
<h1>{$filename}</h1>
...
<html><head>
<title>Query from input Shape file and Metadata</title>
</head>
<body>
<?php 
...
?> 
<h1>Upload Shape(*.shp) and Metadata(*.dbf) File:</h1>
<!--
...
<label for="file">Choose Shp file:</label>
<!-- JavaScript is called by OnChange attribute -->
<input type="file" name="file" id="file" size="64px" onChange="jsShpUpload(this)">
<br>

<label for="file">Choose Dbf file:</label>
<!-- JavaScript is called by OnChange attribute -->
<input type="file" name="file" id="file" size="64px" onChange="jsDbfUpload(this)">
<br>
...
function jsShpUpload(upload_field)
{
...
function jsDbfUpload(upload_field)
{
  jsShpUpload(upload_field);
}
</script>
